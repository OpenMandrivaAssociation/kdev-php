...
Version: 1.1.90
Release: %mkrel 1
Source0: http://fr2.rpmfind.net/linux/KDE/unstable/kdevelop/4.1.90/src/kdevelop-php-%{version}.tar.bz2
License: GPLv2+
Group: Development/Other
Url: http://www.kdevelop.org
BuildRoot: %{_tmppath}/%{name}-%{version}-%{release}-buildroot
BuildRequires: kdelibs4-devel
BuildRequires: kdevplatform4-devel >= 4:1.1.90
BuildRequires: kdevelop-pg-qt-devel
Requires: kdevelop4 >= 4:4.1.90
